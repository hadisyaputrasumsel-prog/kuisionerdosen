...
class AdminController extends Controller
{
    ...
    public function previewLaporan(Request $request)
    {
        ...
        $defaultBab3 = "<p>Survey Kepuasan Mahasiswa Terhadap Dosen dalam Pengajaran Program Studi [NAMA_PRODI] dilakukan pada bulan [PERIODE] dengan menyebarkan kuesioner secara online. Penyebaran kuesioner dilakukan melalui SIMAK dengan menggunakan google drive. Hasil survey diperoleh jumlah responden yang memberikan jawaban sebanyak [TOTAL_RESPONDEN] responden dalam hal ini mahasiswa Program Studi [NAMA_PRODI].</p><p><strong>Dosen Objek Survey</strong><br>Jumlah Dosen Prodi [NAMA_PRODI] yang disurvey sebanyak [TOTAL_DOSEN] orang. Kelompok Dosen digambarkan pada grafik berikut.</p><p>[PIE_CHART_DOSEN]</p><p><strong>Penilaian terhadap Kinerja Dosen dalam Proses Belajar Mengajar, Kapabilitas/ Kompetensi Dosen dan Ketersediaan Sarana Prasaran</strong><br>Hasil survey Kepuasan Mahasiswa terhadap Kapabilitas/ Kompetensi Dosen dan Ketersediaan Sarana Prasaran memperlihatkan bahwa secara umum Dosen Program Studi [NAMA_PRODI] melaksanakan proses pembelajaran [RATA_RATA_PREDIKAT].</p><p><strong>Tabulasi Penilaian Kepuasan Mahasiswa terhadap Dosen dalam Pembelajaran</strong></p><p>[TABEL_EVALUASI]</p><br><p>Berikut diagram survey Kepuasan Mahasiswa terhadap Dosen dalam Pembelajaran :</p>[GRAFIK_INSTRUMEN]";
